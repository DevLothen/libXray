...
const (
	...
	LibXrayMethodReplaceConfig               LibXrayMethod = "replaceConfig"
	LibXrayMethodGetRuntimeDiagnostics       LibXrayMethod = "getRuntimeDiagnostics"
	LibXrayMethodGetTrafficStats             LibXrayMethod = "getTrafficStats"
...
type GetRuntimeDiagnosticsRequest struct {
